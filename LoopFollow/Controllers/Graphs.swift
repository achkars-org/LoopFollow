...
enum GraphDataIndex: Int {
    ...
    case basalMarkers = 19
    case overrideMarkers = 20
}
...
extension MainViewController {
    ...
    func createGraph() {
        ...
        // Dataset 19: Basal segment midpoint markers (one ◆ per rate segment)
        ...
        data.append(lineBasalMarkers) // Dataset 19

        // Dataset 20: Override midpoint markers (one green ◆ per override)
        ...
        data.append(lineOverrideMarkers) // Dataset 20
    ...
    func createSmallBGGraph() {
        ...
        // Dataset 19 & 20: Marker placeholders (not interactive on small chart)
        ...
        data.append(lineBasalMarkersSmall) // Dataset 19
        ...
        data.append(lineOverrideMarkersSmall) // Dataset 20
